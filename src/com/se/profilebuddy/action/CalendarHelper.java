...
import com.se.profilebuddy.activity.MainActivity;
import com.se.profilebuddy.database.ManageEventDB;
import com.se.profilebuddy.database.ManageNotificationDB;
...
public class CalendarHelper
{
	...
	public static final String[] EVENT_COLS = new String[] { Events._ID, Events.TITLE,
			Events.DTSTART, Events.DTEND, Events.DURATION, Events.RRULE, Events.LAST_DATE };
	...
	private static final int EVENT_TITLE_IX = 1;
	...
	private static final int EVENT_LAST_DATE_IX = 6;

	public static final String ACTION_NO_MODE = "com.se.profilebuddy.notification.action.NO_MODE";
	public static final String ACTION_SILENT = "com.se.profilebuddy.notification.action.SILENT";
	public static final String ACTION_VIBRATE = "com.se.profilebuddy.notification.action.VIBRATE";
	public static final String ACTION_NORMAL = "com.se.profilebuddy.notification.action.NORMAL";
	public static final String ACTION_DELETE = "com.se.profilebuddy.notification.action.DELETE";

	public static final String EVENT_ID = "com.se.profilebuddy.CalendarHelper.eventId";
	public static final String NOTIFICATION_ID = "com.se.profilebuddy.CalendarHelper.notificationId";
	...
	public void syncCalendar()
	{
		...
		List<CalendarEvent> events = this.readPrimaryCalendarEvents();
	...
	private void cacheLocalEvents()
	{
		...
		this.eventDB.open();
		this.localEventCache = eventDB.fetchEvents(true);
		this.eventDB.close();
	...
	private void fetchPrimaryCalendar()
	{
		...
		// String selection = Calendars.IS_PRIMARY + " = 1 ";
	 ...
	 */
	private List<CalendarEvent> readPrimaryCalendarEvents()
	{
