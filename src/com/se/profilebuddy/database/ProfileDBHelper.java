package com.se.profilebuddy.database;
...
public class ProfileDBHelper extends SQLiteOpenHelper
{
	...
	private static final String T_EVENT_CREATE = "CREATE TABLE T_EVENT "
			+ "(_id INTEGER PRIMARY KEY AUTOINCREMENT, FOREIGN_EVENT_ID INTEGER NOT NULL UNIQUE, TITLE TEXT NOT NULL, "
			+ "START_TIME INTEGER NOT NULL, END_TIME INTEGER NOT NULL, DURATION INTGER NOT NULL, "
			+ "MODE INTEGER NOT NULL, RECURSIVE INTEGER NOT NULL, STATUS INTEGER NOT NULL);";
	...
	private static final String INDEX_T_EVENT_CREATE = "CREATE INDEX FORIEGN_EVENT_ID_INDEX ON T_EVENT (FOREIGN_EVENT_ID);";
	private static final String INDEX_T_NOTIFICATION_CREATE = "CREATE INDEX EVENT_ID_INDEX ON T_NOTIFICATION (EVENT_ID);";

	// private static final String INSERT_DATA_T_NOTIFICATION =
	// "INSERT INTO T_NOTIFICATION (_id, EVENT_ID) VALUES ()";
	...
	public void onCreate(SQLiteDatabase database)
	{
		...
		database.execSQL(INDEX_T_EVENT_CREATE);
