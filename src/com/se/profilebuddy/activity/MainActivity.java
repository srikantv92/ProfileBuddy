...
import com.se.profilebuddy.adapter.TabsPagerAdapter;
import com.se.profilebuddy.service.LocationService;
import com.se.profilebuddy.service.LocationService.ServiceState;
...
public class MainActivity extends FragmentActivity implements TabListener
{
	...
	private static final String INVOKE_SERVICE = "com.se.profilebuddy.activity.action.INVOKE_SERVICE";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (LocationService.SERV_STATE == ServiceState.OFF)
		{
			...
			// Log.i(TAG, "Calling service 1" + LocationService.SERV_STATE);
