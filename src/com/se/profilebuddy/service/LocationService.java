...
import com.se.profilebuddy.action.ProfileAction;
		...
		OnConnectionFailedListener, LocationListener
{
	...
	{
		Log.i(TAG, "Entering checkProfileChange()");

		profileAction.setCurrentLocation(lastLocation);
		profileAction.manageProfile();

		Log.i(TAG, "Exiting checkProfileChange()");
	}
